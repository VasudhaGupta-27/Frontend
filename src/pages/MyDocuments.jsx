    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-100">
      ...
      <div className="flex flex-col items-center mt-8">
        ...
        <p className="text-gray-600 mb-6 text-center max-w-xl">
          ...
          <span className="font-semibold text-amber-600">Preview</span> to view or
          sign your PDF.
        </p>
      </div>
            ...
            {docs.map((doc, idx) => (
              ...
              >
                ...
                <motion.button
                  ...
                  className="mt-4 md:mt-0 inline-block bg-gradient-to-r from-amber-400 via-amber-500 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-white text-sm px-6 py-2 rounded-lg font-semibold shadow transition-all"
